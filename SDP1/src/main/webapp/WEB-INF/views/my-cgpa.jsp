...
<head>
    <meta charset="UTF-8">
    <title>Student Portal - My CGPA</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="card">
                <% 
                    // Generate a random CGPA between 6.0 and 10.0
                    double randomCGPA = 6.0 + (Math.random() * 4.0);
                    String formattedCGPA = String.format("%.2f", randomCGPA);
                    out.print(formattedCGPA);
                %>
            </div>
        </div>
    </div>
